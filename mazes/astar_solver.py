...
pygame.display.set_caption("Maze Solver with A* Algorithm")
...
def solve_maze(grid):
    ...
    # Dictionary to store the estimated total cost from start to end through this cell
